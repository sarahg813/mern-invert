...
import MiniSearch from "./MiniSearchForm";
...
const SearchResultPage = props => {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, data.studios.length - page * rowsPerPage);
  ...
  return (
    <div>
      ...
      <TableContainer component={Paper}>
        <Table className={classes.table} aria-label="studio list table">
          <TableBody>
            {(rowsPerPage > 0
              ? data.studios.slice(
                  page * rowsPerPage,
